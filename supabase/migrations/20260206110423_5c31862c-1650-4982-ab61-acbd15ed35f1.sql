-- Fix the week start calculation in get_weekly_recipes_by_day RPC
-- PostgreSQL date_trunc('week') returns Monday in ISO mode
-- The +1 was incorrect and causing a 1-day offset
  ...
  FOR v_day_index IN 0..6 LOOP
    ...
    BEGIN
      ...
      SELECT jsonb_build_object(
        ...
        'image_url', COALESCE(
          r.image_url,
          CASE WHEN r.image_path IS NOT NULL AND r.image_path <> '' 
